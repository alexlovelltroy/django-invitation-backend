...
urlpatterns = patterns('',
    ...
    url(r'^accept/(?P<invitation_key>\w+)/$',
        RegistrationView.as_view(template_name="invitation/invitation_accept.html"),
        name='invitation_register'),
    url(r'^invite/welcome/$',
        TemplateView.as_view(template_name='invitation/invitation_welcome.html'),
        name='invitation_welcome'),
    url(r'^wrong-key/$',
